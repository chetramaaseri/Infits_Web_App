...
<body>
  ...
  <div class="main-content">
    ...
    <div class="images" style="display:flex;flex-wrap:wrap;width:100%; margin-top:50px;flex-direction:row !important; margin:30px auto auto 0px">
      ...
      <div class="" style="background-image:url('img/Group 1410112811.svg');background-repeat:no-repeat;background-position:center;position:relative;">
      
        <div><img src="img/Ellipse 401.svg" style="margin-left:64px;"></div>
      ...
      <div class="" style="background-image:url('img/Vector (11).svg');background-repeat:no-repeat;background-position:center;position:relative;">
      
        <div><img src="img/Ellipse 401.svg" style="margin-left:69px;"></div>
        ...
        <div class="goal" style="display:flex;flex-direction:rows;justify-content:space-between; margin:0px 20px 0px 20px">
          ...
          <div><img src="img/Vector (6).svg" style="margin-top:12px"></div>
          ...
          <div><img src="img/Vector (7).svg" style="margin-top:12px"></div>
      ...
      <div class="" style="background-image:url('img/Vector (13).svg');background-repeat:no-repeat;background-position:center;position:relative;background-size:contain;">
      
        <div><img src="img/Ellipse 401.svg" style="margin-left:74px;"></div>
      ...
      <div class="" style="background-image:url('img/Vector (12).svg');background-repeat:no-repeat;background-position:center;position:relative;">
      ...
      <div class="" style="background-image:url('img/Vector (10).svg');background-repeat:no-repeat;background-position:center;position:relative;">
        ...
        <div style="margin-top:-30px !important;">
          ...
          <div class="" style="background-image:url('img/Vector (9).svg');background-repeat:no-repeat;background-position:center;position:relative;">
          
            <div><img src="img/Ellipse 401.svg" style="margin-left:63px;"></div>
            <div style="position:absolute;left: 40%;right: 33.33%;top: 6.9%;bottom: 34.83%;">
