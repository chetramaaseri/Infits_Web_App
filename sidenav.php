...
<body>
    <div class="sidenav" id="sidenavbar">
        ...
        <a id="healthform" class="sidenavlink nav-healthform" href="health_detail_form_blank.php"><img src="images/vec_health_form.svg" class="nav-icon">Health Form</a>
     ...
     <div class="mobile-menu">
        <div id="mySidenav" class="sidenavv">
            ...
            <a href="myform.php"><img src="images/vec_recipies.png">&nbsp&nbsp Health Form</a>
