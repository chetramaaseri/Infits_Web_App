    ...
    <div id="content">
        ...
        color: #76A5FF;text-align:center;">
                <?php echo '<a style="color:#76A5FF;" href="mealTracker.php?client_id='.$client_id.'">' ?>
                    ...
                    <div class="row"><img src="Cutlery.png" style="width:55%;margin-left:8.5rem" alt=""></div>
                    <div class="row">
     ...
     -->
     <div class="image">
        <img src="Vector (3).png" style= " padding: 10 90px; ">
        <img src="Vector (4).png" style= " padding: 90 0px;; ">
     </div>
