...
.tab button:hover {
  background-color:rgba(201, 134, 207, 1);
}
.tab button.active {
  background-color:rgba(201, 134, 207, 1);
    ...
    <div class="content">
        ...
        <div class="row past-header">
            ...
            <div class="col-sm-4 ph-right">
                ...
                <div class="client-card client-card-heart " style="color:rgba(84, 175, 172, 1); border: 1px solid rgba(84, 175, 172, 1);">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-4 activity-content">
                                                        <div class="activity-left">
                                                            <img src="images/weight_icon.svg" alt="">
                                                        ...
                                                        <div class="activity-right">
                                                            <img src="images/weight__icon.svg" alt="">
                                                            <p>66.2 kg</p>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 activity-content">
